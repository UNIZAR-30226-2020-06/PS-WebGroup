...
@NgModule({
  ...
  declarations: [ AppComponent, HelloComponent, LoginComponent, HomeComponent, RegisterComponent, MyProfileComponent, PlayerComponent, MusicPlayerComponent, ProfileComponent, MyProfileEditComponent, MyProfileInfoComponent, MyProfileSongsComponent, MyProfilePodcastsComponent, ProfileInfoComponent, ProfileSongsComponent, ProfilePodcastsComponent, MyProfileUpload1Component, MyProfileUpload2Component],
